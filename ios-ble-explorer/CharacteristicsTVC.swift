...
class CharacteristicsTVC: UITableViewController, CBPeripheralDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = c.value == nil ? "Value: [none]" : "Value: \(String(describing: c.value?.hexadecimalString().stringFromHexadecimalStringUsingEncoding(String.Encoding.utf8)!))"
